...
DROP TABLE RDS;
CREATE EXTERNAL TABLE RDS (STATE STRING, MEASURENAME STRING, MEASUREID STRING, NUMHOSPWORSE STRING, NUMHOSPSAME STRING, NUMHOSPBETTER STRING, NUMHOSPTOOFEW STRING,FOOTNOTE STRING, MEASUREDSTART STRING, MEASUREEND STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE LOCATION '/data/w205tables';
